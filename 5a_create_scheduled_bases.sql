...
where dist.type_fra = tf.type and dist.type_til = tt.type
 window win as (order by "ENHETVAKT", "ORDRENUMMER"),
 win2 as (partition by "ENHETVAKT", "ORDRENUMMER" order by "ENHETAVTALE", "AVTALENUMMER", "AKTOERNR","KUNDE", "ERPOSTAL", "UKEDAGORDRE", "HENTENAVN", "TYPE_FRA", "POSTNR_FRA", "POSTSTED_FRA", "GATEADRESSE_FRA", "RAMMETIDFRAKL_FRA", "RAMMETIDTILKL_FRA", "BRINGENAVN", "TYPE_TIL", "POSTNR_TIL", "POSTSTED_TIL", "GATEADRESSE_TIL", "RAMMETIDFRAKL_TIL", "RAMMETIDTILKL_TIL"),
 win3 as (partition by "ENHETVAKT", "ORDRENUMMER","ENHETAVTALE", "AVTALENUMMER", "AKTOERNR", "KUNDE", "ERPOSTAL", "UKEDAGORDRE", "HENTENAVN", "TYPE_FRA", "POSTNR_FRA", "POSTSTED_FRA", "GATEADRESSE_FRA", "RAMMETIDFRAKL_FRA", "RAMMETIDTILKL_FRA", "BRINGENAVN", "TYPE_TIL", "POSTNR_TIL", "POSTSTED_TIL", "GATEADRESSE_TIL", "RAMMETIDFRAKL_TIL", "RAMMETIDTILKL_TIL" order by "ANTALL", "LASTB")
...
drop table basisamphora2;
create table basisamphora2 as 
select pu_nameLine1, pu_addressLine1, pu_postalCode, pu_CITY, "ref","PossPrincipal","Department","HandlingCode", "Service","Priority","TerminalSearchName","PickupDate","NumberOfPackages","PackageType","GrossWeight","Pallets","LoadingMeters","IsThermoGoods","TemperatureFrom","TemperatureTo","StartingDate","ExpiryDate","LoadPlusDays","UnloadPlusDays",
...
drop table basisamphora3;
create table basisamphora3 as select 
dense_rank() over win ind,
pu_nameLine1, pu_addressLine1, pu_postalCode, pu_CITY,"ref","PossPrincipal","Department","HandlingCode", "Service","Priority","TerminalSearchName","PickupDate", 
PickupFromTime,
PickupTillTime,
"NumberOfPackages",
...
from basisamphora2 
group by pu_nameLine1, pu_addressLine1, pu_postalCode, pu_CITY, "PossPrincipal","Department","HandlingCode","ref", "Service","Priority","TerminalSearchName","PickupDate", 
PickupFromTime,
PickupTillTime,
"NumberOfPackages",
"PackageType","GrossWeight",
...
"ExpiryDate","LoadPlusDays",
"UnloadPlusDays"
window win as (partition by "ref" order by pu_nameLine1, pu_addressLine1, pu_postalCode, pu_CITY, "PossPrincipal","Department","HandlingCode", "Service","Priority","TerminalSearchName","PickupDate", 
PickupFromTime,
PickupTillTime,
"NumberOfPackages",
"PackageType","GrossWeight",
...
drop table basisalystra3;
create table basisalystra3 as select distinct "Reference", "HandlingCode", "Department", "TerminalSearchName","AKTOERNR", "UKEDAGORDRE",
 "HENTENAVN", "TYPE_FRA", "POSTNR_FRA", "POSTSTED_FRA", "GATEADRESSE_FRA", "RAMMETIDFRAKL_FRA", "RAMMETIDTILKL_FRA",
 "BRINGENAVN", "TYPE_TIL", "POSTNR_TIL", "POSTSTED_TIL", "GATEADRESSE_TIL", "RAMMETIDFRAKL_TIL", "RAMMETIDTILKL_TIL",
coalesce(r.relationNumber,99999998) as "Principal" 
from basisalystra2 left join relations r
on AKTOERNR = r.relationNumber;

drop table basisamphora4;
create table basisamphora4 as select 
	ba3.*, 
	coalesce(r.relationNumber,99999998) as "Principal", 
	ref||"-"||ind as Reference,
