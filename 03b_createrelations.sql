...
select row_number() over (partition by ACCOUNT_NUMBER order by ACCOUNT_NUMBER,
 ...
 CITY ,
 COUNTRY ,
 "JGZZ_FISCAL_CODE", attribute10_currency, standard_term) as r, 
 ACCOUNT_NUMBER,
 PARTY_NAME ,
 ACCOUNT_NAME ,
 ADDRESS1 ,
 ...
 CITY ,
 COUNTRY ,
 "JGZZ_FISCAL_CODE",attribute10_currency, standard_term
...
"" as contactPerson,
"1" as typeOfRelation,
attribute10_currency as currencyCode,
"0" as vatCode,
"" as languageCode,
"1" as relationGroup,
t.paymentTerm as paymentTerm,
"" as creditLimit,
"JGZZ_FISCAL_CODE" as vatNumberOrg,
COUNTRY || JGZZ_FISCAL_CODE vatNumber
from customerBasis cb left join terms t on cb.standard_term = t.standard_term
union all
select distinct
"" as searchName,
...
create table registrations as select distinct
 ACCOUNT_NUMBER as Relationnumber,
"1000" as Type,
