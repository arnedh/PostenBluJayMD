...
.header on
.output Converted20191017\\OSL\\mRESOURCES_20191010143322138020.csv
.header on
...
'0' as UNIT_NUMBER,
'END' as END
 from deptresource where department_code='OSL' and name not in (select name from RESOURCES_OSL1);
